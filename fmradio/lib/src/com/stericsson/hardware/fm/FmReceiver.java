...
public abstract class FmReceiver {
    ...
    /**
     * Interface definition of a callback to be invoked when the FmReceiver service is
     * available.
     */
    public interface onServiceAvailableListener {

        /**
         * Called when the FmReceiver service is available.
         */
    ...
    public static FmReceiver createInstance(Context ctx, onServiceAvailableListener cb) {
    	return new FmReceiverImpl(ctx, cb);
    }
}
