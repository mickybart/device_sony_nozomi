...
public abstract class FmTransmitter {
     ...
     */
    public abstract boolean isApiSupported();

    /**
     * Cleanup FM receiver stack.
     */
    ...
    /**
     * Interface definition of a callback to be invoked when the FmTransmitter service is
     * available.
     */
    public interface onServiceAvailableListener {

        /**
         * Called when the FmTransmitter service is available.
         */
    ...
    public static FmTransmitter createInstance(Context ctx, onServiceAvailableListener cb) {
    	return new FmTransmitterImpl(ctx, cb);
    }
}
